              ...
              children: [
                ...
                Expanded(
                  child: ValueListenableBuilder<bool>(
                    valueListenable: context.read<ReceiverInfoViewModel>().isBanksListLoadingNotifier,
                    builder: (_, isLoading, __) {
                      return AnimatedSwitcher(
                        ...
                        child: isLoading
                            ...
                            : ListView.separated(
                                itemCount: context.read<ReceiverInfoViewModel>().getBanks?.getBankListResponseModelBody.length ?? 0,
                                ...
                                itemBuilder: (_, index) {
                                  return ListTile(
                                    ...
                                    title: Text(context.read<ReceiverInfoViewModel>().getBanks?.getBankListResponseModelBody[index].name ?? '',
                                    ...
                                    onTap: () {
                                      context.read<ReceiverInfoViewModel>().bankController.text =
                                          context.read<ReceiverInfoViewModel>().getBanks?.getBankListResponseModelBody[index].name ?? '';
                                      context.read<ReceiverInfoViewModel>().bankId =
                                          context.read<ReceiverInfoViewModel>().getBanks?.getBankListResponseModelBody[index].bankId.toString();
                                      print('this is the bank id ${context.read<ReceiverInfoViewModel>().bankId}');
                                      context.read<ReceiverInfoViewModel>().getBankListResponseModelBody =
                                          context.read<ReceiverInfoViewModel>().getBanks?.getBankListResponseModelBody[index];
